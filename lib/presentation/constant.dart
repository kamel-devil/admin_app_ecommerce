...
const Color color2 =  Color(0xFF515151);
...
const Color gradientTop = Color(0xFF039be6);
const Color gradientBottom = Color(0xFF0299e2);
const Color light = Color(0xFFFCD55F);
const Color underlineColor = Color(0xFFCCCCCC);
const Color topIconColor = Colors.white;
const Color topSearchColor = Colors.white;
